...
<body>
    ...
    <div class="container">
        ...
        <?php
$sql = "SELECT * FROM product WHERE cat_id = 17";
        ...
        <img  src="../dist/uploads/<?php echo $row['prod_pic'];?>">
                <div class="details">
                  ...
                  <p>
                    ...
                    <h3><span class="price"> <?php echo$row['prod_desc'];?></span></h3>
                    
                <a href="rental/create.php">    <span class="add-to-cart-btn" >Rent </span> </a>
                  </p>
                </div>
