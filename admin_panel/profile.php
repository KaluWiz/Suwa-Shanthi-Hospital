	...
	<div class="card-header">
		<ul class="nav nav-tabs card-header-tabs">
			<li class="nav-item"><a class="nav-item nav-link active"
				id="nav-home-tab" data-toggle="tab" href="#nav-profile" role="tab"
				aria-controls="nav-home" aria-selected="true">Profile</a></li>
			<li class="nav-item"><a class="nav-item nav-link"
				id="nav-contact-tab" data-toggle="tab" href="#nav-home" role="tab"
				aria-controls="nav-contact" aria-selected="false">Change Profile</a>
			</li>
			<li class="nav-item"><a class="nav-item nav-link"
				id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
				role="tab" aria-controls="nav-contact" aria-selected="false">Change
					Password</a></li>
		</ul>
	</div>
			...
			<div class="card-body">
				<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-md-6" id="view_full_name"></div>
					</div>
					<div class="row">
						<div class="col-md-2">
					...
					<div class="row">
						...
						<div class="col-md-6" id="view_gender"></div>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6">
								...
								<div class="modal-footer">
									...
									<input type="submit" id="update_profile_button"
										name="update_profile_button" class="btn btn-primary"
										value="Update">
								</div>
							</div>
						</div>
					...
					<form id="update_password_form">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6">
								...
								<div class="form-group">
									<label>Current Password <i class="text-danger">*</i></label> <input
								...
								<div class="form-group">
									<label>New Password <i class="text-danger">*</i></label> <input
										type="password" class="form-control" id="new_password"
										name="new_password" maxlength="50"
								...
								<div class="form-group">
									<label>Confirm Password <i class="text-danger">*</i></label> <input
								...
								<div class="modal-footer">
									<button type="button" id="cancel_update_password_button"
										class="btn btn-light">Cancel</button>
									<input type="submit" id="update_password_button"
										name="update_password_button" class="btn btn-primary"
										value="Update">
								</div>
							</div>
						</div>
