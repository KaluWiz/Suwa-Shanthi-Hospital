...
<div class="card mb-3">
	<div class="card-header">
		...
		<div class="float-right">
			<button type="button" id="add_user" class="btn btn-primary btn-sm">
			...
			<div class="modal-body">
				<form id="user_form">
					<div class="form-group">
						<label>Full Name <i class="text-danger">*</i></label> <input
							type="text" id="full_name" name="full_name" class="form-control"
							maxlength="100" autocomplete="off" placeholder="Enter full name">
						<div id="full_name_error_message" class="text-danger"></div>
					</div>
					<div class="form-group">
						<label>Username <i class="text-danger">*</i></label> <input
					...
					<div class="form-row">
						<div class="form-group col-md-4">
							<label>Gender <i class="text-danger"> *</i></label> <select
								name="gender" id="gender" class="custom-select">
						...
						<div class="form-group col-md-4">
							<label>Role <i class="text-danger"> *</i></label> <select
								name="role" id="role" class="custom-select">
						...
						<div class="form-group col-md-4">
							<label>Status <i class="text-danger"> *</i></label> <select
								name="status" id="status" class="custom-select">
					...
					<div class="form-group">
						<label for="confirm-password">Confirm Password <i
							class="text-danger">*</i></label> <input type="password"
				...
				<div class="card">
					...
					<div class="modal-body">
						<form id="update_profile_form">
							<div class="form-group">
								<label>Full Name <i class="text-danger">*</i></label> <input
									type="text" id="update_full_name" name="update_full_name"
							...
							<div class="form-group">
								<label>Username <i class="text-danger">*</i></label> <input
									type="text" id="update_email" name="update_email"
									class="form-control" maxlength="100" autocomplete="off"
							...
							<div class="form-row">
								<div class="form-group col-md-4">
									<label>Gender <i class="text-danger"> *</i></label> <select
										name="update_gender" id="update_gender" class="custom-select">
										<option value="" hidden>Gender</option>
										<option>Male</option>
										<option>Female</option>
									</select>
								...
								<div class="form-group col-md-4">
									<label>Role <i class="text-danger"> *</i></label> <select
										name="update_role" id="update_role" class="custom-select">
										<option value="" hidden>Role</option>
										<option>Admin</option>
										<option>Manager</option>
										<option>Worker</option>
								...
								<div class="form-group col-md-4">
									<label>Status <i class="text-danger"> *</i></label> <select
										name="update_status" id="update_status" class="custom-select">
										<option value="" hidden>Status</option>
										<option>Active</option>
										<option>Inactive</option>
									</select>
							...
							<div class="modal-footer">
								...
								<button type="button" id="cancel_user_update_button"
									class="btn btn-light" data-dismiss="modal">Cancel</button>
								<input type="submit" name="button_update_profile"
									id="button_update_profile" class="btn btn-primary"
									value="Update" />
							</div>
						</form>
					</div>
						...
						<form id="user_password_form">
							<div class="form-group">
								...
								<input type="password" class="form-control" id="update_password"
									name="update_password" maxlength="50"
							...
							<div class="form-group">
								<label for="confirm-password">Confirm Password <i
									class="text-danger">*</i></label> <input type="password"
									class="form-control" id="update_confirm_password"
									name="update_confirm_password" maxlength="50"
									placeholder="Enter confirm password">
								<div id="update_confirm_password_error_message"
									class="text-danger"></div>
							</div>
							<div class="modal-footer">
								<input type="hidden" name="update_password_id"
									id="update_password_id" />
								<button type="button" id="cancel_passworld_update_button"
									class="btn btn-light" data-dismiss="modal">Cancel</button>
								<input type="submit" name="button_action"
									id="update_button_action" class="btn btn-primary"
									value="Update" />
							</div>
						</form>
					</div>
