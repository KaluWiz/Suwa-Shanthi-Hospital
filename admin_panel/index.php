    ...
    <section class="py-5 text-center container">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-info o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="view_total_users"></b> User Management </h4>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="view_total_active_users"></b> Stock Managemnet </h4>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="../pages/home.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="view_total_inactive_users"></b> Prescription Management  </h4>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="prescribe.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="view_total_new_users"></b> Rent Management </h4>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="../main/rental/index.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
        ...
        <?php } elseif ($_SESSION['user_role']=="Manager") { ?>
         ...
         <section class="py-5 text-center container">
          <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              <h1 class="fw-light">Welcome Manager!</h1>
                <p class="lead text-muted"><?php echo $_SESSION['user_full_name']; ?><p>   
              </p>
            </div>
          </div>
